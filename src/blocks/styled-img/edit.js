...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={__('Image Settings', 'styled-img')} initialOpen={true}>
          <RangeControl
            label={__('Image Width (%)', 'styled-img')}
            value={width}
          ...
          />
          <RangeControl
            label={__('Border Radius (px)', 'styled-img')}
            value={borderRadius}
          ...
          />
          <SelectControl
            label={__('Object Fit', 'styled-img')}
            value={objectFit}
            options={[
          ...
          />
          <SelectControl
            label={__('Aspect Ratio', 'styled-img')}
            value={aspectRatio}
            options={[
          ...
          />
          <ToggleControl
            label={__('Apply Drop Shadow', 'styled-img')}
            checked={applyShadow}
